...
export default {
  ...
  data() {
    return {
      window: {
        headerid: "userInfoTable",
        title: "مشخصات"
      },
      table: {
        selectStore: "userStore",
        getData: "userInfoTable",
        openSelectRow: ["panel", "userInfoEdit",'ویرایش مشخصات'],
        selectRow: "selectUserInfoEdit",
        deleteRow: "",
        excel: "",
        fileNmae: "subCategories.xls",
        column: [
          {
            title: "id",
            type: "number",
