...
export default {
  ...
  data() {
    return {
      window: {
        headerid: "contactTable",
        title: "ارتباط با ما",
        titleLine: "ماژول/ماژول های ارتباطی/ارتباط با ما/مشاهده ارتباط با ما",
      },
      table: {
        selectStore: "ComponentContact",
        getData: "contactTable",
        openSelectRow: ["panel", "contactEdit","ویرایش ارتباط با ما"],
        selectRow: "selectContact",
        deleteRow: "/api/v1/deleteContact/",
