...
export default {
  ...
  data() {
    return {
      refreshPage: true,
      window: {
        headerid: "textRowEdit",
        title: "ویرایش ردیف متنی",
        titleLine: "ماژول/ماژول های گرافیکی/ردیف متنی/ویرایش ردیف متنی",
      },
      edit: {
        buttonTitle: "ویرایش",
        axiosUrl: "/api/v1/editTextRow/",
        response: "selectTextRow",
      },
      statusOption: [
        { id: 0, name: "غیر فعال" },
        { id: 1, name: "فعال" },
  ...
  computed: {
    lastId: {
      get() {
        if (this.$store.state.ComponentTextRow.selectTextRow.id) {
          return this.$store.state.ComponentTextRow.selectTextRow.id;
        } else {
          return "";
        }
      },
    ...
    lastName: {
      get() {
        return this.$store.state.ComponentTextRow.selectTextRow.name;
      },
    },
    lastTitle1: {
      get() {
        return this.$store.state.ComponentTextRow.selectTextRow.title1;
      },
    },
    lastTitle2: {
      get() {
        return this.$store.state.ComponentTextRow.selectTextRow.title2;
      },
    },
    lastTitle3: {
      get() {
        return this.$store.state.ComponentTextRow.selectTextRow.title3;
      },
    },
    lastTitle4: {
      get() {
        return this.$store.state.ComponentTextRow.selectTextRow.title4;
      },
    },
    lastTitle5: {
      get() {
        return this.$store.state.ComponentTextRow.selectTextRow.title5;
      },
    },
    lastTitle6: {
      get() {
        return this.$store.state.ComponentTextRow.selectTextRow.title6;
      },
    },
    lastDescription: {
      get() {
        return this.$store.state.ComponentTextRow.selectTextRow.description;
      },
    },
    lastStatus: {
      get() {
        return this.$store.state.ComponentTextRow.selectTextRow.status;
      },
    },
    lastLink: {
      get() {
        return this.$store.state.ComponentTextRow.selectTextRow.link;
      },
    },
    lastSeo: {
      get() {
        return this.$store.state.ComponentTextRow.selectTextRow.seo;
      },
    },
    lastImage1: {
      get() {
        return this.$store.state.ComponentTextRow.selectTextRow.image1;
      },
    },
    lastImage2: {
      get() {
        return this.$store.state.ComponentTextRow.selectTextRow.image2;
      },
    },
    last_page_language_id: {
      get() {
        return this.$store.state.ComponentTextRow.selectTextRow
          .page_language_id;
      },
    },
    ...
    lastSection: {
      get() {
        return this.$store.state.ComponentTextRow.selectTextRow.section;
      },
    },
  },
  //compute
