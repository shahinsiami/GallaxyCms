...
export default {
  ...
  data() {
    return {
      ...
      window: {
        ...
        titleLine: "ماژول/ماژول های گرافیکی/اسلایدر/ویرایش اسلایدر",
      },
      edit: {
        buttonTitle: "ویرایش",
        axiosUrl: "/api/v1/editSlider/",
        response: "selectSlider",
      },
      statusOption: [
        { id: 0, name: "غیر فعال" },
        { id: 1, name: "فعال" },
  ...
  computed: {
    lastId: {
      get() {
        if (this.$store.state.ComponentSlider.selectSlider.id) {
          return this.$store.state.ComponentSlider.selectSlider.id;
        } else {
          return "";
        }
      },
    ...
    lastName: {
      get() {
        return this.$store.state.ComponentSlider.selectSlider.name;
      },
    },
    lastTitle1: {
      get() {
        return this.$store.state.ComponentSlider.selectSlider.title1;
      },
    },
    lastTitle2: {
      get() {
        return this.$store.state.ComponentSlider.selectSlider.title2;
      },
    },
    lastTitle3: {
      get() {
        return this.$store.state.ComponentSlider.selectSlider.title3;
      },
    },
    lastDescription: {
      get() {
        return this.$store.state.ComponentSlider.selectSlider.description;
      },
    },
    lastStatus: {
      get() {
        return this.$store.state.ComponentSlider.selectSlider.status;
      },
    },
    lastLink: {
      get() {
        return this.$store.state.ComponentSlider.selectSlider.link;
      },
    },
    lastSeo: {
      get() {
        return this.$store.state.ComponentSlider.selectSlider.seo;
      },
    },
    lastImage1: {
      get() {
        return this.$store.state.ComponentSlider.selectSlider.image1;
      },
    },
    lastImage2: {
      get() {
        return this.$store.state.ComponentSlider.selectSlider.image2;
      },
    },
    last_page_language_id: {
      get() {
        return this.$store.state.ComponentSlider.selectSlider.page_language_id;
      },
    },
    last_page_template_id: {
      get() {
        return this.$store.state.ComponentSlider.selectSlider.page_template_id;
      },
    },
    lastSection: {
      get() {
        return this.$store.state.ComponentSlider.selectSlider.section;
      },
    },
  },
  //compute
