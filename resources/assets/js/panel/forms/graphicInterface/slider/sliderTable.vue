...
export default {
  ...
  data() {
    return {
      window: {
        headerid: "sliderTable",
        title: "اسلایدرها",
        titleLine: "ماژول/ماژول های گرافیکی/اسلایدر/اسلایدرها",
      },
      table: {
        selectStore: "ComponentSlider",
        getData: "sliderTable",
        openSelectRow: ["panel", "sliderEdit","ویرایش اسلایدر"],
        selectRow: "selectSlider",
        deleteRow: "/api/v1/deleteSlider/",
