...
export default {
  ...
  data() {
    return {
      refreshPage: true,
      window: {
        headerid: "twoColumnEdit",
        title: "ویرایش دو ستونه",
        titleLine: "ماژول/ماژول های گرافیکی/دو ستونه/ویرایش دو ستونه",
      },
      edit: {
        buttonTitle: "ویرایش",
        axiosUrl: "/api/v1/editTwoColumn/",
        response: "selectTwoColumn",
      },
      statusOption: [
        { id: 0, name: "غیر فعال" },
        { id: 1, name: "فعال" },
  ...
  computed: {
    lastId: {
      get() {
        if (this.$store.state.ComponentTwoColumn.selectTwoColumn.id) {
          return this.$store.state.ComponentTwoColumn.selectTwoColumn.id;
        } else {
          return "";
        }
      },
    ...
    lastName: {
      get() {
        return this.$store.state.ComponentTwoColumn.selectTwoColumn.name;
      },
    },
    lastTitle1: {
      get() {
        return this.$store.state.ComponentTwoColumn.selectTwoColumn.title1;
      },
    },
    lastTitle2: {
      get() {
        return this.$store.state.ComponentTwoColumn.selectTwoColumn.title2;
      },
    },
    lastTitle3: {
      get() {
        return this.$store.state.ComponentTwoColumn.selectTwoColumn.title3;
      },
    },
    lastDescription: {
      get() {
        return this.$store.state.ComponentTwoColumn.selectTwoColumn.description;
      },
    },
    lastStatus: {
      get() {
        return this.$store.state.ComponentTwoColumn.selectTwoColumn.status;
      },
    },
    lastLink: {
      get() {
        return this.$store.state.ComponentTwoColumn.selectTwoColumn.link;
      },
    },
    lastSeo: {
      get() {
        return this.$store.state.ComponentTwoColumn.selectTwoColumn.seo;
      },
    },
    lastImage1: {
      get() {
        return this.$store.state.ComponentTwoColumn.selectTwoColumn.image1;
      },
    },
    lastImage2: {
      get() {
        return this.$store.state.ComponentTwoColumn.selectTwoColumn.image2;
      },
    },
    last_page_language_id: {
      get() {
        return this.$store.state.ComponentTwoColumn.selectTwoColumn
          .page_language_id;
      },
    },
    ...
    lastSection: {
      get() {
        return this.$store.state.ComponentTwoColumn.selectTwoColumn.section;
      },
    },
  },
  //compute
