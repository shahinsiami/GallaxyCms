...
export default {
  ...
  data() {
    return {
      refreshPage: true,
      window: {
        headerid: "twoColumnTable",
        title: "دو ستونه ها",
        titleLine: "ماژول/ماژول های گرافیکی/دو ستونه/ دو ستونه ها",
      },
      table: {
        selectStore: "ComponentTwoColumn",
        getData: "twoColumnTable",
        openSelectRow: ["panel", "twoColumnEdit","ویرایش دوستونه"],
        selectRow: "selectTwoColumn",
        deleteRow: "/api/v1/deleteTwoColumn/",
