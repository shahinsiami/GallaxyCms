...
export default {
  ...
  data() {
    return {
      window: {
        headerid: "flashSaleTable",
        title: "ثانیه شمارها",
                titleLine: "ماژول/ماژول های گرافیکی/ثانیه شمار/مشاهده ثانیه شمارها",
      },
      table: {
        selectStore: "ComponentFlashSale",
        getData: "flashSaleTable",
        openSelectRow: ["panel", "flashSaleEdit","ویرایش ثانیه شمار"],
        selectRow: "selectFlashSale",
        deleteRow: "/api/v1/deleteFlashSale/",
