...
export default {
  ...
  data() {
    return {
      ...
      window: {
        headerid: "rowEdit",
        title: "ویرایش ردیف انتخابی",
        titleLine: "ماژول/ماژول های گرافیکی/ردیف انتخابی/ویرایش ردیف انتخابی",
      },
      edit: {
        buttonTitle: "ویرایش",
        axiosUrl: "/api/v1/editRow/",
        response: "selectRow",
      },
      statusOption: [
        { id: 0, name: "غیر فعال" },
  ...
  computed: {
    lastId: {
      get() {
        if (this.$store.state.ComponentRow.selectRow.id) {
          return this.$store.state.ComponentRow.selectRow.id;
        } else {
          return "";
        }
      },
    ...
    lastName: {
      get() {
        return this.$store.state.ComponentRow.selectRow.name;
      },
    },
    lastTitle1: {
      get() {
        return this.$store.state.ComponentRow.selectRow.title1;
      },
    },
    lastTitle2: {
      get() {
        return this.$store.state.ComponentRow.selectRow.title2;
      },
    },
    lastTitle3: {
      get() {
        return this.$store.state.ComponentRow.selectRow.title3;
      },
    },
    lastDescription: {
      get() {
        return this.$store.state.ComponentRow.selectRow.description;
      },
    },
    lastStatus: {
      get() {
        return this.$store.state.ComponentRow.selectRow.status;
      },
    },
    lastLink: {
      get() {
        return this.$store.state.ComponentRow.selectRow.link;
      },
    },
    lastSeo: {
      get() {
        return this.$store.state.ComponentRow.selectRow.seo;
      },
    },
    lastImage1: {
      get() {
        return this.$store.state.ComponentRow.selectRow.image1;
      },
    },
    lastImage2: {
      get() {
        return this.$store.state.ComponentRow.selectRow.image2;
      },
    },
    last_page_language_id: {
      get() {
        return this.$store.state.ComponentRow.selectRow.page_language_id;
      },
    },
    last_page_template_id: {
      get() {
        return this.$store.state.ComponentRow.selectRow.page_template_id;
      },
    },

    lastSection: {
      get() {
        return this.$store.state.ComponentRow.selectRow.section;
      },
    },
  },
  //compute
