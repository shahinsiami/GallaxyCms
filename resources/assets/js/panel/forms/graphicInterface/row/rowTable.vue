...
export default {
  ...
  data() {
    return {
      window: {
        headerid: "rowTable",
        title: "ردیف های انتخابی",
        titleLine: "ماژول/ماژول های گرافیکی/ردیف انتخابی/ردیف های انتخابی",
      },
      table: {
        selectStore: "ComponentRow",
        getData: "rowTable",
        openSelectRow: ["panel", "rowEdit","ویرایش ردیفی"],
        selectRow: "selectRow",
        deleteRow: "/api/v1/deleteRow/",
