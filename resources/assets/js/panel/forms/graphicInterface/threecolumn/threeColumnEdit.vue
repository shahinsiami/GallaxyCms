...
export default {
  ...
  data() {
    return {
      refreshPage: true,
      window: {
        headerid: "threeColumnEdit",
        title: "ویرایش سه ستونه",
        titleLine: "ماژول/ماژول های گرافیکی/سه ستونه/ویرایش سه ستونه ",
      },
      edit: {
        buttonTitle: "ویرایش",
        axiosUrl: "/api/v1/editThreeColumn/",
        response: "selectThreeColumn",
      },
      statusOption: [
        { id: 0, name: "غیر فعال" },
        { id: 1, name: "فعال" },
  ...
  computed: {
    lastId: {
      get() {
        if (this.$store.state.ComponentThreeColumn.selectThreeColumn.id) {
          return this.$store.state.ComponentThreeColumn.selectThreeColumn.id;
        } else {
          return "";
        }
      },
    ...
    lastName: {
      get() {
        return this.$store.state.ComponentThreeColumn.selectThreeColumn.name;
      },
    },
    lastTitle1: {
      get() {
        return this.$store.state.ComponentThreeColumn.selectThreeColumn.title1;
      },
    },
    lastTitle2: {
      get() {
        return this.$store.state.ComponentThreeColumn.selectThreeColumn.title2;
      },
    },
    lastTitle3: {
      get() {
        return this.$store.state.ComponentThreeColumn.selectThreeColumn.title3;
      },
    },
    lastDescription: {
      get() {
        return this.$store.state.ComponentThreeColumn.selectThreeColumn
          .description;
      },
    },
    lastStatus: {
      get() {
        return this.$store.state.ComponentThreeColumn.selectThreeColumn.status;
      },
    },
    lastLink: {
      get() {
        return this.$store.state.ComponentThreeColumn.selectThreeColumn.link;
      },
    },
    lastSeo: {
      get() {
        return this.$store.state.ComponentThreeColumn.selectThreeColumn.seo;
      },
    },
    lastImage1: {
      get() {
        return this.$store.state.ComponentThreeColumn.selectThreeColumn.image1;
      },
    },
    lastImage2: {
      get() {
        return this.$store.state.ComponentThreeColumn.selectThreeColumn.image2;
      },
    },
    ...
    lastSection: {
      get() {
        return this.$store.state.ComponentThreeColumn.selectThreeColumn.section;
      },
    },
  },
  //compute
