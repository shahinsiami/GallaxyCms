...
export default {
  ...
  data() {
    return {
      window: {
        headerid: "fourColumnTable",
        title: "چهار ستونه ها",
        titleLine: "ماژول/ماژول های گرافیکی/چهارستونه/چهارستونه ها",
      },
      table: {
        selectStore: "ComponentFourColumn",
        getData: "fourColumnTable",
        openSelectRow: ["panel", "fourColumnEdit","ویرایش چهارستونه"],
        selectRow: "selectFourColumn",
        deleteRow: "/api/v1/deleteFourColumn/",
