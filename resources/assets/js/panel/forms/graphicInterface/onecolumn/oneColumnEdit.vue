...
export default {
  ...
  data() {
    return {
      refreshPage: true,
      window: {
        headerid: "oneColumnEdit",
        title: "ویرایش یک ستونه",
        titleLine: "ماژول/ماژول های گرافیکی/یک ستونه/ویرایش یک ستونه",
      },
      edit: {
        buttonTitle: "ویرایش",
        axiosUrl: "/api/v1/editOneColumn/",
        response: "selectOneColumn",
      },
      statusOption: [
        { id: 0, name: "غیر فعال" },
        { id: 1, name: "فعال" },
  ...
  computed: {
    lastId: {
      get() {
        if (this.$store.state.ComponentOneColumn.selectOneColumn.id) {
          return this.$store.state.ComponentOneColumn.selectOneColumn.id;
        } else {
          return "";
        }
      },
    ...
    lastName: {
      get() {
        return this.$store.state.ComponentOneColumn.selectOneColumn.name;
      },
    },
    lastTitle1: {
      get() {
        return this.$store.state.ComponentOneColumn.selectOneColumn.title1;
      },
    },
    lastTitle2: {
      get() {
        return this.$store.state.ComponentOneColumn.selectOneColumn.title2;
      },
    },
    lastTitle3: {
      get() {
        return this.$store.state.ComponentOneColumn.selectOneColumn.title3;
      },
    },
    lastDescription: {
      get() {
        return this.$store.state.ComponentOneColumn.selectOneColumn.description;
      },
    },
    lastStatus: {
      get() {
        return this.$store.state.ComponentOneColumn.selectOneColumn.status;
      },
    },
    lastLink: {
      get() {
        return this.$store.state.ComponentOneColumn.selectOneColumn.link;
      },
    },
    lastSeo: {
      get() {
        return this.$store.state.ComponentOneColumn.selectOneColumn.seo;
      },
    },
    lastImage1: {
      get() {
        return this.$store.state.ComponentOneColumn.selectOneColumn.image1;
      },
    },
    lastImage2: {
      get() {
        return this.$store.state.ComponentOneColumn.selectOneColumn.image2;
      },
    },
    last_page_language_id: {
      get() {
        return this.$store.state.ComponentOneColumn.selectOneColumn
          .page_language_id;
      },
    },
    ...
    lastSection: {
      get() {
        return this.$store.state.ComponentOneColumn.selectOneColumn.section;
      },
    },
  },
  //compute
