...
export default {
  ...
  data() {
    return {
      window: {
        headerid: "oneColumnTable",
        title: "یک ستونه ها",
        titleLine: "ماژول/ماژول های گرافیکی/یک ستونه/ یک ستونه ها",
      },
      table: {
        selectStore: "ComponentOneColumn",
        getData: "oneColumnTable",
        openSelectRow: ["panel", "oneColumnEdit","ویرایش یک ستونه"],
        selectRow: "selectOneColumn",
        deleteRow: "/api/v1/deleteOneColumn/",
