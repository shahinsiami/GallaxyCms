...
export default {
  ...
  data() {
    return {
      refreshPage: true,
      window: {
        headerid: "galleryTable",
        title: "گالری ها",
        titleLine: "ماژول/ماژول های گرافیکی/گالری/تصویر ها",
      },
      table: {
        selectStore: "ComponentGallery",
        getData: "galleryTable",
        openSelectRow: ["panel", "galleryEdit","ویرایش گالری"],
        selectRow: "selectGallery",
        deleteRow: "/api/v1/deleteGallery/",
