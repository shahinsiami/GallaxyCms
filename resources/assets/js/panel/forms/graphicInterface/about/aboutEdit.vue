...
export default {
  ...
  data() {
    return {
      ...
      window: {
        ...
        titleLine: "ماژول/ماژول های ارتباطی/درباره ما/ویرایش درباره ما",
      },
      edit: {
        buttonTitle: "ویرایش",
        axiosUrl: "/api/v1/editAbout/",
        response: "selectAbout",
      },
      statusOption: [
        { id: 0, name: "غیر فعال" },
        { id: 1, name: "فعال" },
  ...
  computed: {
    lastId: {
      get() {
        if (this.$store.state.ComponentAbout.selectAbout.id) {
          return this.$store.state.ComponentAbout.selectAbout.id;
        } else {
          return "";
        }
      },
    ...
    lastTitle1: {
      get() {
        return this.$store.state.ComponentAbout.selectAbout.title1;
      },
    },
    lastTitle2: {
      get() {
        return this.$store.state.ComponentAbout.selectAbout.title2;
      },
    },
    lastTitle3: {
      get() {
        return this.$store.state.ComponentAbout.selectAbout.title3;
      },
    },
    lastDescription: {
      get() {
        return this.$store.state.ComponentAbout.selectAbout.description;
      },
    },
    lastStatus: {
      get() {
        return this.$store.state.ComponentAbout.selectAbout.status;
      },
    },
    lastLink: {
      get() {
        return this.$store.state.ComponentAbout.selectAbout.link;
      },
    },
    lastSeo: {
      get() {
        return this.$store.state.ComponentAbout.selectAbout.seo;
      },
    },
    lastImage1: {
      get() {
        return this.$store.state.ComponentAbout.selectAbout.image1;
      },
    },
    lastImage2: {
      get() {
        return this.$store.state.ComponentAbout.selectAbout.image2;
      },
    },
    last_page_language_id: {
      get() {
        return this.$store.state.ComponentAbout.selectAbout.page_language_id;
      },
    },
    last_page_template_id: {
      get() {
        return this.$store.state.ComponentAbout.selectAbout.page_template_id;
      },
    },
  },
  //compute
