...
export default {
  ...
  data() {
    return {
      window: {
        headerid: "manyColumnTable",
        title: "چند ستونه ها",
        titleLine: "ماژول/ماژول های گرافیکی/چندستونه/چندستونه ها",
      },
      table: {
        selectStore: "ComponentManyColumn",
        getData: "manyColumnTable",
        openSelectRow: ["panel", "manyColumnEdit","ویرایش چند ستونه"],
        selectRow: "selectManyColumn",
        deleteRow: "/api/v1/deleteManyColumn/",
