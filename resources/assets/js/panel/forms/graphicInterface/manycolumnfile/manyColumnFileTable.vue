...
export default {
  ...
  data() {
    return {
      window: {
        headerid: "manyColumnFileTable",
        title: "چند ستونه های فایلی",
        titleLine: "ماژول/ماژول های گرافیکی/چندستونه فایلی/چند ستونه های فایلی",
      },
      table: {
        selectStore: "ComponentManyColumnFile",
        getData: "manyColumnFileTable",
        openSelectRow: ["panel", "manyColumnFileEdit","ویرایش چند ستونه فایلی"],
        selectRow: "selectManyColumnFile",
        deleteRow: "/api/v1/deleteManyColumnFile/",
