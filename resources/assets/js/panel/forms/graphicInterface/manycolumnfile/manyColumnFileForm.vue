...
export default {
  ...
  data() {
    return {
      refreshPage: true,
      window: {
        headerid: "manyColumnFileForm",
        title: "ثبت چندستونه فایلی",
        titleLine: "ماژول/ماژول های گرافیکی/چندستونه فایلی/ثبت چندستونه فایلی"
      },
      submit: {
        buttonTitle: "ثبت",
        axiosUrl: "/api/v1/registerManyColumnFile"
      },
      statusOption: [
        { id: 0, name: "غیر فعال" },
        { id: 1, name: "فعال" }
