...
export default {
  ...
  data() {
    return {
      refreshPage: true,
      window: {
        headerid: "carouselEdit",
        title: "ویرایش لیست چرخشی",
        titleLine: "ماژول/ماژول های گرافیکی/لیست چرخشی/ویرایش لیست چرخشی ",
      },
      edit: {
        buttonTitle: "ویرایش",
        axiosUrl: "/api/v1/editCarousel/",
        response: "selectCarousel",
      },
      statusOption: [
        { id: 0, name: "غیر فعال" },
        { id: 1, name: "فعال" },
  ...
  computed: {
    lastId: {
      get() {
        if (this.$store.state.ComponentCarousel.selectCarousel.id) {
          return this.$store.state.ComponentCarousel.selectCarousel.id;
        } else {
          return "";
        }
      },
    ...
    lastName: {
      get() {
        return this.$store.state.ComponentCarousel.selectCarousel.name;
      },
    },
    lastTitle1: {
      get() {
        return this.$store.state.ComponentCarousel.selectCarousel.title1;
      },
    },
    lastTitle2: {
      get() {
        return this.$store.state.ComponentCarousel.selectCarousel.title2;
      },
    },
    lastTitle3: {
      get() {
        return this.$store.state.ComponentCarousel.selectCarousel.title3;
      },
    },
    lastDescription: {
      get() {
        return this.$store.state.ComponentCarousel.selectCarousel.description;
      },
    },
    lastStatus: {
      get() {
        return this.$store.state.ComponentCarousel.selectCarousel.status;
      },
    },
    lastLink: {
      get() {
        return this.$store.state.ComponentCarousel.selectCarousel.link;
      },
    },
    lastSeo: {
      get() {
        return this.$store.state.ComponentCarousel.selectCarousel.seo;
      },
    },
    lastImage1: {
      get() {
        return this.$store.state.ComponentCarousel.selectCarousel.image1;
      },
    },
    lastImage2: {
      get() {
        return this.$store.state.ComponentCarousel.selectCarousel.image2;
      },
    },
    last_page_language_id: {
      get() {
        return this.$store.state.ComponentCarousel.selectCarousel
          .page_language_id;
      },
    },
    ...
    lastSection: {
      get() {
        return this.$store.state.ComponentCarousel.selectCarousel.section;
      },
    },
  },
  //compute
