...
export default {
  ...
  data() {
    return {
      window: {
        headerid: "carouselTable",
        title: "لیست های چرخشی",
                titleLine: "ماژول/ماژول های گرافیکی/لیست چرخشی/لیست های چرخشی",
      },
      table: {
        selectStore: "ComponentCarousel",
        getData: "carouselTable",
        openSelectRow: ["panel", "carouselEdit","ویرایش لیست چرخشی"],
        selectRow: "selectCarousel",
        deleteRow: "/api/v1/deleteCarousel/",
