...
export default {
  ...
  data() {
    return {
      window: {
        headerid: "subCategoryTable",
        title: "زیرمجموعه ها",
        titleLine: "زیرمجموعه / زیر مجموعه ها",
      },
      table: {
        selectStore: "formSubCategory",
        getData: "subCategoryTable",
        openSelectRow: ["panel", "subCategoryEdit", "ویرایش زیرمجموعه"],
        selectRow: "selectSubCategory",
        deleteRow: "/api/v1/deleteSubCategory/",
