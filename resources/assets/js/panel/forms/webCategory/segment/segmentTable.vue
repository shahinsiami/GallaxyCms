...
export default {
  ...
  data() {
    return {
      window: {
        headerid: "segmentTable",
        title: "دسته ها",
        titleLine: "دسته / دسته ها",

      },
      table: {
        selectStore: "formSegment",
        getData: "segmentTable",
        openSelectRow: ["panel", "segmentEdit", "ویرایش دسته"],
        selectRow: "selectSegment",
        deleteRow: "/api/v1/deletSegment/",
