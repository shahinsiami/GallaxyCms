...
export default {
  ...
  data() {
    return {
      window: {
        headerid: "cropCategoryTable",
        title: "مجموعه های محصولات ",
        titleLine: "محصولات/دسته بندی/مجموعه/مجموعه های محصولات",
      },
      table: {
        selectStore: "formCropCategory",
        getData: "cropCategoryTable",
        openSelectRow: ["panel", "cropCategoryEdit", "ویرایش مجموعه محصولات"],
        selectRow: "selectCropCategory",
        deleteRow: "/api/v1/deleteCropCategory/",
