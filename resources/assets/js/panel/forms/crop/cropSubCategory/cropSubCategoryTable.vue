...
export default {
  ...
  data() {
    return {
      window: {
        headerid: "cropSubCategoryTable",
        title: "زیرمجموعه های محصولات",
        titleLine: "محصولات/دسته بندی/زیرمجموعه/زیرمجموعه های محصولات",
      },
      table: {
        selectStore: "formCropSubCategory",
        getData: "cropSubCategoryTable",
        openSelectRow: [
          "panel",
          "cropSubCategoryEdit",
          "ویرایش زیرمجموعه محصولات",
        ],
        selectRow: "selectCropSubCategory",
        deleteRow: "/api/v1/deleteCropSubCategory/",
