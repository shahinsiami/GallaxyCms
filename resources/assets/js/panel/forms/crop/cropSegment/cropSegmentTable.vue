...
export default {
  ...
  data() {
    return {
      window: {
        headerid: "cropSegmentTable",
        title: "دسته های محصولات",
        titleLine: "محصولات/دسته بندی/دسته/دسته های محصولات",
      },
      table: {
        selectStore: "formCropSegment",
        getData: "cropSegmentTable",
        openSelectRow: ["panel", "cropSegmentEdit", "ویرایش دسته محصولات"],
        selectRow: "selectCropSegment",
        deleteRow: "/api/v1/deleteCropSegment/",
