    ...
    <div v-if="lastId !== '' && this.refreshPage" class="container-fluid">
      <div style="direction:rtl">
        ...
        <div class="d-flex flex-row w-100 justify-content-start align-items-center vpc_nav">
          <div @click="showTab1" v-bind:class="[this.tab1 ? 'vpc_nav_item_selected' : '']" class="vpc_nav_item d-flex flex-row justify-content-center align-items-center">مقاله اصلی</div>
          <div @click="showTab2" v-bind:class="[this.tab2 ? 'vpc_nav_item_selected' : '']" class="vpc_nav_item d-flex flex-row justify-content-center align-items-center">مشخصات زیر مقاله</div>
          <div @click="showTab3" v-bind:class="[this.tab3 ? 'vpc_nav_item_selected' : '']" class="vpc_nav_item d-flex flex-row justify-content-center align-items-center">متن زیر مقاله</div>
          <div @click="showTab4" v-bind:class="[this.tab4 ? 'vpc_nav_item_selected' : '']" class="vpc_nav_item d-flex flex-row justify-content-center align-items-center">تصاویر</div>
        </div>
      </div>
      <!---->
...
export default {
  ...
  data() {
    return {
      ...
      refreshPage: true,
      window: {
        headerid: "articleSubEdit",
        title: "ویرایش زیر مقاله",
        titleLine: "زیرمقاله / ویرایش  زیرمقاله",
      },
      edit: {
        buttonTitle: "ویرایش",
        axiosUrl: "/api/v1/editArticleSub/",
        response: "selectArticleSub"
      },
      data: {
        id: "",
        title: "",
  ...
  watch: {
    ...
    last_web_article_id: function() {
      this.data.web_article_id = this.last_web_article_id;
    }
  },
  //watch
  //compute
  ...
  computed: {
    lastId: {
      get() {
        if (this.$store.state.formArticleSub.selectArticleSub.id) {
          return this.$store.state.formArticleSub.selectArticleSub.id;
        } else {
          return "";
        }
      }
    ...
    lastTitle: {
      get() {
        return this.$store.state.formArticleSub.selectArticleSub.title;
      }
    },
    lastDescription: {
      get() {
        return this.$store.state.formArticleSub.selectArticleSub.description;
      }
    },
    lastShortDescription: {
      get() {
        return this.$store.state.formArticleSub.selectArticleSub
          .shortdescription;
      }
    },
    ...
    lastImage1: {
      get() {
        return this.$store.state.formArticleSub.selectArticleSub.image1;
      }
    },
    lastImage2: {
      get() {
        return this.$store.state.formArticleSub.selectArticleSub.image2;
      }
    },
    lastImage3: {
      get() {
        return this.$store.state.formArticleSub.selectArticleSub.image3;
      }
    },
    lastImage4: {
      get() {
        return this.$store.state.formArticleSub.selectArticleSub.image4;
      }
    },
    lastImage5: {
      get() {
        return this.$store.state.formArticleSub.selectArticleSub.image5;
      }
    },
    lastImage6: {
      get() {
        return this.$store.state.formArticleSub.selectArticleSub.image6;
      }
    },
    lastTag: {
      get() {
        if (this.$store.state.formArticleSub.selectArticleSub.tag) {
          return this.$store.state.formArticleSub.selectArticleSub.tag;
        } else {
          return "[]";
        }
      }
    ...
    lastSeo: {
      get() {
        return this.$store.state.formArticleSub.selectArticleSub.seo;
      }
    },
    last_priority: {
      get() {
        return this.$store.state.formArticleSub.selectArticleSub.priority;
      }
    },
    last_web_article_id: {
      get() {
        return this.$store.state.formArticleSub.selectArticleSub.web_article_id;
      }
    }
  },
  //compute
