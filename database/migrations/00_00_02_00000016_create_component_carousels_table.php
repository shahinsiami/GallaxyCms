...
class CreateComponentCarouselsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('component_carousels', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name');
    ...
    {
        Schema::dropIfExists('component_carousels');
    }
}
