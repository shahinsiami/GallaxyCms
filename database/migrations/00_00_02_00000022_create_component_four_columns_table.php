...
class CreateComponentFourColumnsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('component_four_columns', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name');
    ...
    {
        Schema::dropIfExists('component_four_columns');
    }
}
