...
class CreateComponentFlashSalesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('component_flash_sales', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('component_flash_sales');
    }
}
