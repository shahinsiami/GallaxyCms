...
use App\Model\WebSite\General\ClientAddress;
use App\Model\WebSite\General\ClientInfo;
use App\Model\WebSite\Shopping\ClientCart;
use App\Model\WebSite\Shopping\ClientInterest;
...
class User extends Authenticatable
{
    ...
    public function cart(){
        return $this->hasMany(ClientCart::class,'user_id');
    }
    public function interestCrop(){
        return $this->hasMany(ClientInterest::class,'user_id');
    }
    public function purchaseInvoice(){
        return $this->hasMany(PurchaseInvoice::class,'user_id');
    }
    public function purchaseInvoiceDetail(){
        return $this->hasMany(purchaseInvoiceDetail::class,'user_id');
    }
